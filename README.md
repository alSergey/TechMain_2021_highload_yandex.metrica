...
Каждый ДЦ будет состоять из Nginx, бекенда, серверов кластера ClickHouse.
...
Найти точного географического распределения Яндекс Метрики не удалось, поэтому будем предполагать, что она очень популярна в России и странах СНГ, чуть менее популярна в Европе и США. Поэтому расположим три ДЦ в России, один в Европе и один в США.
